...
public class Constants {
    ...
    public static final float ICICLE_SPAWNS_PER_SECOND = 10.f;
    ...
    public enum Difficulty { //TODO What is an enum and what does this do?
    ...
    public static final float DIFFICULTY_LABLE_SCALE = 1.5f;
